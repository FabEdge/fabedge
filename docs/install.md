...
如果没有满足该前提条件，请参考[部署K8S集群](https://github.com/FabEdge/fabedge/blob/main/docs/install_kubernets.md)  
...
### 2.4 为[strongswan](https://www.strongswan.org/)生成证书
